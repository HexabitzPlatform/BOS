...
uint16_t rejectedMsg =0, acceptedMsg =0, timedoutMsg =0, ADCPort =0,
    ADCSide =0;
float InternalVoltageReferance =0, InternalTemperature =0, ADCPercentage =0,
    ADCValue =0;
							...
							MBmessageParams[1] =
							    ((uint32_t) cMessage[port - 1][5 + shift]
							        ...
							        + ((uint32_t) cMessage[port - 1][8
							            + shift] << 24);
							MBmessageParams[2] =
							    ((uint32_t) cMessage[port - 1][9 + shift]
							        << 0)
