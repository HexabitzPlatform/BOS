...
enum modulePartNumbers_e{_H01R0=1, _P01R0, _H02R0, _H02R1, _H04R0, _H05R0, _H07R0, _H08R0, _H09R0, _H11R2, _H12R0, _H17R0, _H21R0};
...
extern uint8_t N;
extern const char modulePNstring[14][6];
