...
enum modulePartNumbers_e{_H01R0=1, _P01R0, _H23R0, _H23R1, _H07R3, _H1BR6, _H12R0, _H13R7, _H0FR6, _H11R2, _H0AR9, _H17R0, _H21R0, _H24R0};
...
extern uint8_t N;
extern const char modulePNstring[15][6];
